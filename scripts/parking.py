...
class image_converter:
    ...
    def __init__(self):
        ...
        self.parking_img = cv2.imread('parking.png', cv2.IMREAD_COLOR)
        
        self.match_pub = rospy.Publisher("rover/control/parking", Bool)
    ...
    def callback(self, msg):
        ...
        kp1, des1 = self.surf.detectAndCompute(self.parking_img, None)
        ...
        matches_img = cv2.drawMatches(self.parking_img, kp1, image, kp2, good, None, **draw_params)
